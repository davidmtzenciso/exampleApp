Feature: Create an Account 
	...
	Scenario Outline: <testCase> <expectedResult>
		...
		Given user wants to create an account with the properties
		| id | firstName   | lastName   | pin   | accountHoldersId   | balance   |
		|    | <firstName> | <lastName> | <pin> | <accountHoldersId> | <balance> |
		
		When user wants to save the new account '<testCase>'
		Then the operation '<expectedResult>'
		...
		Examples:
			...
			| WITH AN ID NUMBER         	 | FAILS					|    |  David        | Martìnez Enciso	  | 1234   | 12345678         | 1000.0  |
